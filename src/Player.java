...
public class Player {
	...
	*/
	...
	public void moveUp(long delta){
		...
		if (cy > v_limit[0] + (height/2)){//só anda se não bater nas paredes. o height/2 é a borda de si mesmo
			cy = cy - (delta*speed);
		}
	...
	*/
	...
	public void moveDown(long delta){
		...
		if (cy < v_limit[1] - (height/2)){//só anda se não bater nas paredes. o height/2 é a borda de si mesmo
			cy = cy + (delta*speed);
		}
